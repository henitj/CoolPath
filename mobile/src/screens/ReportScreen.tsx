...
const styles = StyleSheet.create({
  ...
  hero: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 4, marginBottom: 17 },
  heroIcon: { width: 53, height: 53, borderRadius: 27, backgroundColor: '#FFF0EE', alignItems: 'center', justifyContent: 'center' },
  title: { color: C.ink, fontSize: 21, fontWeight: '800', letterSpacing: -0.35 },
  subtitle: { color: C.inkDim, fontSize: 12.5, marginTop: 2, lineHeight: 17 },
  locationCard: { flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: C.line, backgroundColor: '#F6FBF7', padding: 11, borderRadius: R.m, marginBottom: 12 },
  ...
  calibrateLink: { color: C.mintDeep, fontSize: 12, fontWeight: '800' },
  formCard: { backgroundColor: C.surface, padding: 14, borderRadius: R.l, borderWidth: 1, borderColor: C.lineSoft, ...SHADOW.card },
  formTitle: { color: C.ink, fontSize: 16, fontWeight: '800', marginBottom: 11 },
  categoryGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  category: { width: '31.8%', minHeight: 72, padding: 7, borderWidth: 1, borderColor: C.lineSoft, backgroundColor: C.surfaceHi, borderRadius: R.m, alignItems: 'center', justifyContent: 'center', gap: 4 },
  categorySelected: { backgroundColor: C.mintDeep, borderColor: C.mintDeep },
  categoryText: { color: C.inkDim, fontSize: 10.5, fontWeight: '700', textAlign: 'center' },
  categoryTextSelected: { color: '#FFFFFF' },
  fieldLabel: { color: C.inkFaint, fontSize: 10.5, fontWeight: '800', letterSpacing: 0.7, textTransform: 'uppercase', marginTop: 14, marginBottom: 6 },
  severityRow: { flexDirection: 'row', gap: 9 },
  severityButton: { width: 35, height: 35, borderRadius: 18, borderWidth: 1, borderColor: C.line, alignItems: 'center', justifyContent: 'center', backgroundColor: C.surfaceHi },
  severityOn: { backgroundColor: '#FFF4D7', borderColor: '#E6AF44' },
  severitySelected: { borderWidth: 2, borderColor: C.coral },
  severityText: { color: C.inkFaint, fontSize: 12.5, fontWeight: '800' },
  severityTextOn: { color: C.sun },
  note: { minHeight: 72, textAlignVertical: 'top', color: C.ink, fontSize: 13, backgroundColor: C.surfaceHi, borderWidth: 1, borderColor: C.lineSoft, borderRadius: R.m, padding: 10, marginTop: 13 },
  message: { color: C.coral, fontSize: 11.5, lineHeight: 16, fontWeight: '600', marginTop: 9 },
  messageGood: { color: C.mintDeep },
  submit: { minHeight: 47, backgroundColor: C.mintDeep, borderRadius: R.m, marginTop: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  submitText: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' },
  disabled: { opacity: 0.6 },
  listHeading: { marginTop: 20, marginBottom: 7, paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  listTitle: { color: C.ink, fontSize: 15, fontWeight: '800' },
  listCount: { color: C.inkFaint, fontSize: 11.5, fontWeight: '700' },
  empty: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 15, borderRadius: R.m, borderWidth: 1, borderColor: C.lineSoft, backgroundColor: C.surface },
  emptyText: { color: C.inkDim, fontSize: 12.5, fontWeight: '600' },
  hazardRow: { flexDirection: 'row', alignItems: 'center', gap: 10, overflow: 'hidden', backgroundColor: C.surface, borderRadius: R.m, borderWidth: 1, borderColor: C.lineSoft, paddingVertical: 10, paddingRight: 11, marginBottom: 7 },
  hazardStripe: { width: 4, alignSelf: 'stretch' },
